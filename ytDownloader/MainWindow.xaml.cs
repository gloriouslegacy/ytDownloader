...
namespace ytDownloader
{
    public partial class MainWindow : Window
    {
        ...
        //        AppendOutput($" 업데이트 파일 다운로드 완료: {tempZip}");
        ...
        //        AppendOutput($" 업데이터 경로: {updaterPath}");
        //        AppendOutput($" 설치 디렉터리: {installDir}");
        //        AppendOutput($" 대상 실행파일: {targetExe}");

        //        // Updater.exe 존재 확인
        //        if (!File.Exists(updaterPath))
        //        {
        //            MessageBox.Show($" Updater.exe를 찾을 수 없습니다.\n경로: {updaterPath}", "업데이트 오류",
        ...
        //        AppendOutput($" 업데이터 실행 중...");
        //        AppendOutput($"   명령어: {psi.FileName} {psi.Arguments}");
        ...
        //        AppendOutput(" 업데이터가 실행되었습니다. 현재 앱을 종료합니다.");
        ...
        //    catch (Exception ex)
        //    {
        //        string errorMessage = $"업데이트 실행 실패: {ex.Message}\n\n상세 정보:\n{ex}";
        //        AppendOutput($" {errorMessage}");
        //        MessageBox.Show(errorMessage, "업데이트 오류",
        //            MessageBoxButton.OK, MessageBoxImage.Error);
        //    }
        //}
